#  baby-step giant-step, Pollard’s and brute-force performance comparison 
...
def compute_all(func):
    ...
    with multiprocessing.Pool() as pool:
        ...
        for i, (x, y, steps) in enumerate(results):
            ...
            if i % 100 == 0:
                print('\rComputing all logarithms: {:.2f}% done'.format(100 * i / (curve.n - 1)), end='')
                sys.stdout.flush()
...
def main():
    ...
    for mod in all_mods:
        ...
        print('Took {}m {}s ({} steps on average)'.format(minutes, seconds, round(average_steps)))
